  ...
  return user?.ownerOf ? (
    ...
    <>
      <div className="min-h-[85vh] flex items-center justify-center px-4 sm:px-6 lg:px-0">
        <div className="w-full max-w-full sm:max-w-[90%] lg:max-w-[70%] bg-white rounded-2xl p-5 sm:p-8 text-center">
          <div className="mx-auto w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center rounded-full bg-primary/10 mb-5 sm:mb-6">
          ...
          <p className="text-tetiary text-sm mb-6 w-full sm:w-[80%] lg:w-[60%] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
            <button
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary/90 transition cursor-pointer"
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-primary/30 text-primary text-sm font-medium hover:bg-primary/10 transition cursor-pointer"
            >
          ...
          <div className="border-t border-tetiary/30 pt-6">
            <p className="text-xs font-semibold text-tetiary mb-4 tracking-wide">
              WHY BUILD A TEAM?
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
              <div className="flex gap-3 items-start">
                <div className="w-8 h-8 flex items-center justify-center rounded-xl bg-primary/10 shrink-0">
              ...
              <div className="flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-tetiary">Delegate with clarity</p>
                </div>
              </div>
